...
/// Pantry choices are reviewed from Recipe Review instead of repeating them
...
/// edited together from the compact Recipe Review summary.
...
struct StoreDashboardView: View {
    ...
    var body: some View {
        ...
        .padding(.top, 8)
        .smartCartBackground()
        .navigationTitle("Retailer & Location")
        .navigationBarTitleDisplayMode(.inline)
        .toolbar {
